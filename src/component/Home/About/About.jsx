          ...
          <div className="col-md-6 ps-2">
            <Fade duration={2000} right>
              ...
              <h1 className="headerTitle">
                ...
                <span className="headerHighlight">CONSTRUCTION</span> GOAL
              </h1>
              <p className="headerContent">
                Choosing a suitable theme for your construction isn’t hard if
                you know what to look for. A solid bundled contact form plugin
                enables customers to make contact with you, and a means of
                displaying your construction and location information
                prominently is also essential.
              </p>
